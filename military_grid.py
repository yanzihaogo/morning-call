...
3. 🧬【学术级医药前沿】（2-4条）：搜索过去48小时内全球前沿医学突破或顶级医学期刊的重磅研究。
   - 核心摘要要求（极度重要）：摘要部分必须用2-3句话、极其精炼和专业地讲透以下三点：
     ① 该研究试图解决什么具体的医学或临床痛点问题；
     ② 研究采用了什么核心方法、前沿技术或新材料；
     ③ 该研究的绝对创新点或突破口是什么。
4. 🌟【优选自选股雷达】（1-2只）：从医药、军工、电网、新能源等她关注的板块中，精选1-2只近期基本面极佳或资金明显抢筹的优质个股，推荐加入自选股股票池，并给出推荐逻辑。
5. 🎯【核心金股量价追踪】：必须且只能分析【航发科技、航天动力、航发控制、奥瑞德、长江电力、多氟多】。
   - 【资金面】：复盘主力资金动向（如：北向资金、机构净买入/卖出情况）。
   - 【关键点位】：测算并给出近期的【支撑位】与【压力位】具体价格或区间。
   - 【历史长线】：简述其目前处于历史的什么阶段。
   - 【操作建议】：给出加/减仓建议及具体理由。
